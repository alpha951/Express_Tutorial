const products = [
  {
    ...
    reviews: [{ reviewId: 1, content: 'Some random review to be used as dummy data' }, { reviewId: 2, content: 'Some random review to be used as dummy data' }, { reviewId: 3, content: 'Some random review to be used as dummy data' }]
  },
  {
    id: 2,
